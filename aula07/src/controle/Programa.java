...
public class Programa {
    public static void main(String[] args) {
        ...
        System.out.println("Primeiro nome da coleção: " + listaNomes.firstElement());

        System.out.println("Último nome da coleção: " + listaNomes.lastElement());

        System.out.println("Terceiro nome da coleção: " + listaNomes.get(2));

        System.out.println("Primeira posição de Maria: " + listaNomes.indexOf("Maria"));

        System.out.println("Última posição de Maria: " + listaNomes.lastIndexOf("Maria"));
